<main class="main-content dt-sl mt-4 mb-3">
    <div class="container main-container">
        <div class="row mb-5">
            <aside class="sidebar col-lg-4 hidden-md order-2 pr-0">
            ...
            <div class="col-lg-8 col-md-12 order-1">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/1.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/2.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/3.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/4.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/5.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/6.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/img-slider-2/7.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                ...
                <section id="main-slider-res" class="main-slider carousel slide carousel-fade card d-none show-sm" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/slider-responsive/1.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/slider-responsive/2.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/slider-responsive/3.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/slider-responsive/4.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/slider-responsive/5.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                        <div class="carousel-item">
                            <a class="main-slider-slide" href="#">
                                <img src="./assets/img/main-slider/slider-responsive/6.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="product-carousel carousel-md owl-carousel owl-theme">
                                ...
                                if ($getLatestProduct) {
                                    foreach ($getLatestProduct as $item) {
                                        ...
                                        $photos = sortingArray(json_decode($item->photos, true) ?? [], 'photo_sort', 'ASC');
                                ?>
                                        <div class="item">
                                            <div class="product-card">
                                                ...
                                                <a class="product-thumb" href="<?php echo productLink($item->slug) ?>">
                                                    <img src="<?php echo publicBaseUrl(@$photos[0]['photo_src'] . @$photos[0]['photo_name']); ?>" alt="Product Thumbnail">
                                                </a>
                                                <div class="product-card-body">
                                                    <h5 class="product-title">
                                                        <a href="<?php echo productLink($item->slug) ?>"><?php echo $item->title; ?></a>
                                                    </h5>
                                                    <a class="product-meta" href="shop-categories.html"><?php echo $categories[0]->category_title; ?></a>
                                                    <span class="product-price"><?php echo number_format($item->price) ?> تومان</span>
                                                </div>
                                            </div>
                                        </div>
                                <?php
                ...
                <div class="category-section dt-sn dt-sl">
                    ...
                    <div class="category-section-slider dt-sl">
                        <div class="category-slider owl-carousel">
                            ...
                            <div class="item">
                                <a href="#" class="promotion-category">
                                    <img src="./assets/img/category/restaurant-cutlery-circular-symbol-of-a-spoon-and-a-fork-in-a-circle.png" alt="">

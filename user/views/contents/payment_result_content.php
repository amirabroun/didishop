            ...
            <div class="cart-page-content col-12 px-0">
                <div class="checkout-alert dt-sn mb-4">
                    ...
                    <div class="checkout-alert-title">
                        <h4> سفارش <span class="checkout-alert-highlighted checkout-alert-highlighted-success">DDC-75007560</span>با موفقیت در سیستم ثبت شد.</h4>
                    </div>
                    ...
                    <div class="checkout-details-title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <a href="#" class="btn-primary-cm bg-secondary btn-with-icon d-block text-center pr-0">
        ...
        <div class="row">
            <div class="cart-page-content col-12 px-0">
                <div class="checkout-alert dt-sn mb-4">
                    ...
                    <div class="checkout-alert-title">
                        <h4> سفارش <span class="checkout-alert-highlighted checkout-alert-highlighted-success">DDC-75007560</span>

    ...
    <div class="container main-container">
        ...
        <div class="title-breadcrumb-special dt-sl mb-3">
            <div class="breadcrumb dt-sl">
                <nav>
                    <a href="<?php echo categoryLink($categories[0]->category_slug)?>"><?php echo $categories[0]->category_title ?></a>
                    <a href="#"><?php echo $getProductDetails->title ?></a>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 pb-5 ps-relative">
                    ...
                    <!--<div class="product-timeout position-relative pt-5 mb-3">
                        ...
                        <div class="countdown-timer" countdown data-date="10 24 2021 20:20:22">
                        ...
                        <div class="product-carousel owl-carousel">
                            ...
                            if (!empty($photos)) {
                                foreach ($photos as $photo) {
                                    ?>
                                    <div class="item">
                                        <a class="gallery-item" href="<?php echo publicBaseUrl($photo['photo_src'] . $photo['photo_name']) ?>" data-fancybox="gallery1" data-hash="<?php echo $photo['photo_sort'] ?>">
                                            <img src="<?php echo publicBaseUrl($photo['photo_src'] . $photo['photo_name']) ?>" alt="Product">
                                        </a>
                                    </div>
                                    <?php
                                }
                                ...
                                ?>
                                <div class="item">
                                    <a class="gallery-item" href="{...}" data-fancybox="gallery1" data-hash="none">
                                        <img src="{...}" alt="Product">
                                    </a>
                                </div>
                                <?php
                        ...
                        <ul class="product-thumbnails">
                            ...
                            if (!empty($photos)) {
                                foreach ($photos as $photo) {
                                    ?>
                                    <li class="active">
                                        <a href="#<?php echo $photo['photo_sort'] ?>">
                                            <img src="<?php echo publicBaseUrl($photo['photo_src'] . $photo['photo_name']) ?>" alt="Product">
                                        </a>
                                    </li>
                                    <?php
                ...
                <div class="col-lg-8 col-md-6 pb-5">
                    <div class="product-info dt-sl">
                        <div class="product-title dt-sl">
                            <h1><?php echo $getProductDetails->title ?></h1>
                        </div>
                        ...
                        <div class="section-title text-sm-title title-wide no-after-title-wide mb-0 dt-sl">
                            <h2>کد محصول:<?php echo $getProductDetails->tracking_code ?></h2>
                        </div>
                        <div class="section-title text-sm-title title-wide no-after-title-wide mb-0 dt-sl">
                            <?php
                            if (empty($getProductDetails->price_discounted)) {
                                ?>
                                <h3>قیمت : <span class="price"><?php echo price($getProductDetails->price) ?></span> </h3>
                                <?php
                            } else {
                                ?>
                                <h3>قیمت : <span class="price"><?php echo price($getProductDetails->price_discounted) ?></span> </h3>
                                <h3>قیمت : <del class=""><?php echo price($getProductDetails->price) ?></del> </h3>
                                <?php
                            }
                            ?>
                        </div>
                        <div class="dt-sl mt-4">
                            <a href="<?php echo url("/add-cart.php?product=$getProductDetails->tracking_code"); ?>" class="btn-primary-cm btn-with-icon">

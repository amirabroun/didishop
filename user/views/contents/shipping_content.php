                ...
                <section class="page-content dt-sl">
                                            ...
                                            <div class="checkout-address-box is-selected">
                                                ...
                                                <ul class="checkout-address-list">
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <button class="checkout-address-btn-edit" data-toggle="modal" data-target="#modal-location-edit">ویرایش</button>
                                                            </li>
                                                            <li>
                                                                <button class="checkout-address-btn-remove" data-toggle="modal" data-target="#remove-location">حذف</button>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                    ...
                    <form method="post" id="shipping-data-form" class="dt-sn pt-3 pb-3">
                        ...
                        <div class="checkout-shipment mb-4">
                            ...
                            <div class="custom-control custom-radio  pl-0 pr-3">
                                <input type="radio" class="custom-control-input" name="radio1" id="radio2" value="option2">
                                ...
                                <div class="col-12">
                                    <div class="checkout-tab-times dt-sl">
                                        <ul class="nav nav-tabs dt-sl" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link disabled" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">
                                                    پنج شنبه
                                                    <span>28 شهریور</span>
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content dt-sl" id="myTabContent">
                                            <div class="tab-pane px-2 pt-2 fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="custom-control custom-radio pl-0 pr-3">
                                                    <input type="radio" class="custom-control-input" name="radio2" id="radio4" value="option1">
                                                ...
                                                <div class="custom-control custom-radio pl-0 pr-3">
                                                    <input type="radio" class="custom-control-input" name="radio2" id="radio5" value="option2" checked="">
                                                    <label for="radio5" class="custom-control-label">
                                                        ساعت 13 تا 15
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="tab-pane px-2 pt-2 fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                <div class="custom-control custom-radio pl-0 pr-3">
                                                    <input type="radio" class="custom-control-input" name="radio3" id="radio6" value="option1">
                                                ...
                                                <div class="custom-control custom-radio pl-0 pr-3">
                                                    <input type="radio" class="custom-control-input" name="radio3" id="radio7" value="option2" checked="">
                                                    <label for="radio7" class="custom-control-label">
                                                        ساعت 13 تا 15
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="tab-pane px-2 pt-2 fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">...</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="radio-box custom-control custom-radio pl-0 pr-3">
                                            ...
                                            <label for="1" class="custom-control-label">
                                                <img src="./assets/img/svg/d86ea8ec.svg" class="checkout-additional-options-checkbox-image" />
                    ...
                    <div class="mt-5">
                        <a href="#" class="float-right border-bottom-dt"><i class="mdi mdi-chevron-double-right"></i>بازگشت به سبد خرید</a>
                        <a href="#" class="float-left border-bottom-dt">تایید و ادامه ثبت سفارش<i class="mdi mdi-chevron-double-left"></i></a>
                    </div>
                </section>
            </div>
            <div class="col-xl-3 col-lg-4 col-12 w-res-sidebar sticky-sidebar">
                <div class="dt-sn mb-2">
                    ...
                    <div class="checkout-summary-content">
                        ...
                        <a href="<?php echo url('payment.php'); ?>" class="mb-2 d-block">
                        ...
                        <div>
                            ...
                            </span><span class="help-sn" data-toggle="tooltip" data-html="true" data-placement="bottom" title="<div class='help-container is-right'><div class='help-arrow'></div><p class='help-text'>محصولات موجود در سبد خرید شما تنها در صورت ثبت و پرداخت سفارش برای شما رزرو می‌شوند. در صورت عدم ثبت سفارش، دیجی‌کالا هیچگونه مسئولیتی در قبال تغییر قیمت یا موجودی این کالاها ندارد.</p></div>">
                                <span class="mdi mdi-information-outline"></span>
                            </span>
                        </div>
                    </div>
